    ...
    <div class="pet-quick-info">
        ...
        <div class="quick-info-card">
            ...
            <div class="quick-info-content">
                ...
                <span class="info-value"><?php echo htmlspecialchars($pet['weight'] ?? 'N/A'); ?> kg</span>
            </div>
        </div>
        ...
        <div class="details-main">
            ...
            <div class="additional-info-section">
                ...
                <div class="info-grid-details">
                    ...
                    <div class="info-detail-item">
                        <span class="detail-label"><i class="fas fa-money-bill"></i> Price</span>
                        <span class="detail-value"><?php echo htmlspecialchars($pet['price']); ?></span>
                    </div>
